...
public class CommentController {
    ...
    public Result selectTree(@PathVariable Integer fid, @PathVariable String module, Integer pageNum, Integer pageSize){
        PageInfo<Comment> page = commentService.selectTree(fid, module, pageNum, pageSize);
        return Result.success(page);
    }
